...
const Mcard = (curElem) => {
    ...
    return (
        <div className='max-w-md sm:h-auto h-[336px]  p-2 bg-white border border-gray-200  shadow dark:bg-gray-800 dark:border-gray-700'>
            ...
            <h2 className='mb-2 sm:text-xl text-sm sm:h-auto h-[78px] font-bold tracking-tight text-black dark:text-white'>{shortenText(curElem.mname, 100)}</h2>
